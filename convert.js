...
var add_inputs, arr_copy, blank, cancel, cancel_R, choose_version, control, copy_recursion, ctrl_copy, ctrl_cut, ctrl_paste, cur_, current, current_version, cursor, cut_recursion, down, down_R, draw, editor_mode, end, enter, enter_R, esc, go_ahead, go_back, history, history_make, history_reset, home, home_R, input, input_R, keymap, left, left_R, left_step, left_step_R, ll, new_footer, output, pair_num, paste_recursion, pgdown, pgup, pgup_R, remove, remove_R, reverse, reverse_action, right, right_step, run_code, save_version, skip, snippet, socket, source, space, space_R, stay, stemp, store, tag, up, valid_chars, version_cursor, version_map, view_recursion, view_version,
  __slice = [].slice,
...
window.onload = function() {
  ...
  (refresh = function() {
    ...
    return history_make(store.concat());
  })();
  if (typeof io !== "undefined" && io !== null) {
