...
var add_inputs, available_chars, blank, cancel, control, cursor, down, draw, end, enter, esc, home, input, keymap, left, ll, remove, render_cursor, reverse, right, space, store, tag, up,
  __slice = [].slice,
