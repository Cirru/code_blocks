...
var add_inputs, available_chars, blank, cancel, choose_version, control, ctrl_copy, ctrl_cut, ctrl_paste, current_version, cursor, down, draw, editor_mode, end, enter, esc, home, input, keymap, left, left_step, ll, new_footer, pair_num, remove, render_cursor, reverse, right, right_step, save_version, snippet, space, store, tag, up, version_cursor, version_map, view_version,
  __slice = [].slice,
