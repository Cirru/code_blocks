...
var add_inputs, available_chars, blank, cancel, control, ctrl_copy, ctrl_cut, ctrl_paste, cursor, down, draw, end, enter, esc, home, input, keymap, left, left_step, ll, remove, render_cursor, reverse, right, right_step, snippet, space, store, tag, up,
  __slice = [].slice,
